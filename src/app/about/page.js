...
export default function About() {
  return (
    <article>
      ...
      <section className={styles.section}>
        <h3 className={styles.h3}>Screenings</h3>
        <h4>North America</h4>
        <p>
        ...
        <p>
          Philadelphia Q Festival, USA 7th Southwest Gay & Lesbian Film
          Festival, USA
        </p>
        ...
        <p>
          15th Edition of Madrid International Gay & Lesbian Film Festival,
          Spain
        </p>
